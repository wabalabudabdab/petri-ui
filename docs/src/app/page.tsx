    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="mx-auto max-w-3xl text-center space-y-6">
          <h1 className="text-5xl font-bold tracking-tight">GenLab UI</h1>
          ...
          <div className="rounded-lg bg-muted p-4 font-mono text-sm">bun add @wabalabudabdab/genlab-ui</div>
          <div className="flex justify-center gap-4">
            ...
            <Link href="/docs/components/button" className="rounded-lg border px-6 py-2.5 text-sm font-medium hover:bg-accent">Компоненты</Link>
          </div>
        </div>
        <div className="mt-20">
