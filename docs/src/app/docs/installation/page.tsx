  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-lg text-muted-foreground">Как подключить Petri UI к проекту.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <CodeBlock code={`bun add @wabalabudabdab/petri-ui\n# или\nnpm install @wabalabudabdab/petri-ui`} filename="Terminal" />
      </div>
      <div className="space-y-4">
