'use client';
import { Alert, AlertTitle, AlertDescription } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Alert, AlertTitle, AlertDescription } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
