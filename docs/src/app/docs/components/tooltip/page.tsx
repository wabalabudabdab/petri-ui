'use client';
import { Tooltip, TooltipTrigger, TooltipContent, Button } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Tooltip, TooltipTrigger, TooltipContent } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
