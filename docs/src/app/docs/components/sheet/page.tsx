'use client';
import { Sheet, SheetTrigger, SheetContent, SheetHeader, SheetTitle, SheetDescription, Button } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Sheet, SheetTrigger, SheetContent, SheetHeader, SheetTitle } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
