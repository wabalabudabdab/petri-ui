'use client';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Tabs, TabsList, TabsTrigger, TabsContent } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
