'use client';
import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogAction, AlertDialogCancel, Button } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { AlertDialog, AlertDialogTrigger, AlertDialogContent, AlertDialogAction, AlertDialogCancel } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
