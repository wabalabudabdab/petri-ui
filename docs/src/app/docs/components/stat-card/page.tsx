'use client';
import { StatCard, StatsGrid } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { StatCard, StatsGrid } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
