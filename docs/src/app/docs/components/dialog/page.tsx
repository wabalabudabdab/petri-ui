'use client';
import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, DialogDescription, Button } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
