...
import { HighlightText, Input, Label } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { HighlightText } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
