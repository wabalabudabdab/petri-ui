'use client';
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
