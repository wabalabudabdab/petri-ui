'use client';
import { PasswordInput, Label } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { PasswordInput } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
