...
import { ConfirmDialog, Button } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { ConfirmDialog } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
