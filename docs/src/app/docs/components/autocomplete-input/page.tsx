...
import { AutocompleteInput, Label } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { AutocompleteInput } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
