'use client';
import { Popover, PopoverTrigger, PopoverContent, Button, Input, Label } from '@wabalabudabdab/genlab-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Popover, PopoverTrigger, PopoverContent } from '@wabalabudabdab/genlab-ui';`} /></DocSection>
</DocPage>); }
