'use client';
import { Avatar, AvatarImage, AvatarFallback } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Avatar, AvatarImage, AvatarFallback } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
