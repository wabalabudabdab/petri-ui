'use client';
import { Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { Select, SelectTrigger, SelectValue, SelectContent, SelectItem } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
