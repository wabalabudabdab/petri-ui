'use client';
import { RadioGroup, RadioGroupItem, Label } from '@wabalabudabdab/petri-ui';
...
<DocSection title="Импорт"><CodeBlock code={`import { RadioGroup, RadioGroupItem } from '@wabalabudabdab/petri-ui';`} /></DocSection>
</DocPage>); }
